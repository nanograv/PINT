    ...
    def __init__(self):
        ...
        self.add_param(
            prefixParameter(
                name="PWSTART_1",
                units="MJD",
                description_template=self.__class__._description_solution_epochstart,
                parameter_type="MJD",
                time_scale="tdb",
            )
        )
        ...
        self.add_param(
            prefixParameter(
                name="PWSTOP_1",
                units="MJD",
                description_template=self.__class__._description_solution_epochstop,
                parameter_type="MJD",
                time_scale="tdb",
            )
        )
        self.add_param(
            prefixParameter(
                name="PWEP_1",
                units="MJD",
                description_template=self.__class__._description_solution_epoch,
                parameter_type="MJD",
                time_scale="tdb",
            )
        )
        self.add_param(
            prefixParameter(
                ...
                units="",
                value=0.0,
                description_template=self.__class__._description_solution_startphase,
                type_match="float",
                uncertainty=1,
            )
        )
        self.add_param(
            prefixParameter(
                ...
                units="Hz",
                value=0.0,
                description_template=self.__class__._description_solution_frequency,
                type_match="float",
            )
        )
        self.add_param(
            prefixParameter(
                ...
                units="Hz/s",
                value=0.0,
                description_template=self.__class__._description_solution_frequencyderivative,
            )
        )
        self.add_param(
            prefixParameter(
                ...
                units="Hz/s^2",
                value=0.0,
                description_template=self.__class__._description_solution_secondfrequencyderivative,
            )
        )
