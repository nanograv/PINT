...
def _description_solution_epochstart(x):
    return ("Start epoch of solution piece %d" % x,)


def _description_solution_epochstop(x):
    return ("Stop epoch of solution piece %d" % x,)


def _description_solution_epoch(x):
    return ("Epoch of solution piece %d" % x,)


def _description_solution_startphase(x):
    return ("Starting phase of solution piece %d" % x,)


def _description_solution_frequency(x):
    return "Frequency of solution piece %d" % x


def _description_solution_frequencyderivative(x):
    return "Frequency-derivative of solution piece %d " % x


def _description_solution_secondfrequencyderivative(x):
    ...
    def __init__(self):
        ...
        self.add_param(
            prefixParameter(
                ...
                description_template=_description_solution_epochstart,
                parameter_type="MJD",
                time_scale="tdb",
            )
        )
        ...
        self.add_param(
            prefixParameter(
                ...
                # unit_template=lambda x: "MJD",
                # description_template=lambda x: "Epoch of solution piece %d" % x,
                description_template=_description_solution_epochstop,
                parameter_type="MJD",
                time_scale="tdb",
            )
        )
        self.add_param(
            prefixParameter(
                ...
                # unit_template=lambda x: "MJD",
                # description_template=lambda x: "Epoch of solution piece %d" % x,
                description_template=_description_solution_epoch,
                parameter_type="MJD",
                time_scale="tdb",
            )
        )
        self.add_param(
            prefixParameter(
                ...
                #% x,
                description_template=_description_solution_startphase,
        ...
        self.add_param(
            prefixParameter(
                ...
                description_template=_description_solution_frequency,
        ...
        self.add_param(
            prefixParameter(
                ...
                # " %d " % x,
                description_template=_description_solution_frequencyderivative,
        ...
        self.add_param(
            prefixParameter(
                ...
                # " %d " % x,
                description_template=_description_solution_secondfrequencyderivative,
