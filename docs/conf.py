...
def _process_module_docstring(app, what, name, obj, options, lines):
    ...
    Ensure that the first line of the module docstring winds up in the
    section header and thus in the table of contents.

    Unfortunately it's not clear how to make this title replace the
    package heading generated by apidoc - that can be removed, but
    then we don't get a hierarchical tree any more.
    """
