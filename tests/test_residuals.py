...
class TestResidualBuilding:
    ...
    def test_build_phase_residual(self):
        ...
        phase_res_nomean = Residuals(toas=self.toa,
                                  model=self.model,
                                  residual_type='toa',
                                  subtract_mean=False,
                                  )
        ...
        phase_res_noweight = Residuals(toas=self.toa,
                                  model=self.model,
                                  residual_type='toa',
                                  subtract_mean=True,
                                  use_weighted_mean=False
                                  )
        phase_res_no_f0_scale = Residuals(toas=self.toa,
                                  model=self.model,
                                  residual_type='toa',
                                  scaled_by_F0=False
                                  )
    ...
    def test_build_dm_residual(self):
        ...
        # Test no mean subtraction
        dm_res_nomean = Residuals(toas=self.toa,
                                  model=self.model,
                                  residual_type='dm',
                                  subtract_mean=False,
                                  )
        ...
        dm_res_noweight = Residuals(toas=self.toa,
                                  model=self.model,
                                  residual_type='dm',
                                  subtract_mean=True,
                                  use_weighted_mean=False
