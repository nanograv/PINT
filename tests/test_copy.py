...
class TestObjectCopy:
    ...
    def test_copy_wideband_fitter_object(self):
        ...
        for ii in range(len(fitter.designmatrix_makers)):
            assert fitter.designmatrix_makers[ii].derivative_quantity == fitter_copy.designmatrix_makers[ii].derivative_quantity
            assert fitter.designmatrix_makers[ii].quantity_unit == fitter_copy.designmatrix_makers[ii].quantity_unit
