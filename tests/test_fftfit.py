...
def test_fftfit_classic_runs():
    ...
    shift, eshift, snr, esnr, b, errb, ngood = fftfit_classic(
        template, amp, pha, code="presto"
    )
...
def test_fftfit_classic_compare(n, s):
    ...
    shift, eshift, snr, esnr, b, errb, ngood = fftfit_classic(
        profile, amp, pha, code="aarchiba"
    )
    shift_p, eshift_p, snr_p, esnr_p, b_p, errb_p, ngood_p = fftfit_classic(
        profile, amp, pha, code="presto"
    )
